...
// print_r_pre($GLOBALS);
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        $rs->addnew_link = "?act=com-search_poster";
...
//        }
        ...
        $temp_table = ' poster';
        $list_field = ' SQL_CALC_FOUND_ROWS *, photo as poster_photo ';
        ...
        $rs->SetRecordCol("Poster Photo", "poster_photo");
        $rs->SetRecordCol("Poster Date", "poster_date");
        ...
        $sort = GENERAL_NO;
        $edit = GENERAL_YES;
        $rs->SetRecordCol("MODIFY", "id", $sort, $edit,"?act=com-modify_poster","modid");
        $rs->SetRecordCol("DEL", "id", $sort, $edit,"?act=com-modify_poster","delid");
        $rs->SetRSSorting('?act=com-search_poster');
