...
$rs = $mysql->q('select vid from invoice where mark_date > ? and mark_date < ?', '2015-10-01', '2016-10-01');

if ($rs) {
    $invoice_rtn = $mysql->fetch();
    foreach ($invoice_rtn as $v) {
        ...
        //找到調高度的方法了
        $pdf->Ln(1);
        $html = '<span align="right"><b>Invoice</b><span/>';
...
//product 的個數
        ...
        */
        ...
        $pdf->Output($_SERVER['DOCUMENT_ROOT'] . '/pdf/invoice_151001-161001/' . $result1['vid'] . '.pdf', 'F');
