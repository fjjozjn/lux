...
<?
	...
	if ($getAnyPost || isset($_GET['page'])){
		...
		$rs->addnew_link = "?act=com-searchproduct_e";
		...
		$rs->SetRecordCol("Price(USD)", "cost_rmb");
		...
		$sort = GENERAL_NO;
		$edit = GENERAL_YES;
		//$rs->SetRecordCol("Detail", "pid", $sort, $edit,"?act=com-modifyproduct_e","modid");
		$rs->SetRSSorting('?act=com-searchproduct_e');
