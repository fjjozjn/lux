...
<?
	...
	if ($getAnyPost || isset($_GET['page'])){
		...
		$rs->addnew_link = "?act=com-searchinvoice";
		...
		$temp_table = ' invoice';
		$list_field = ' SQL_CALC_FOUND_ROWS vid, send_to, mark_date, printed_by, remark, istatus, reference, total ';
		...
		//$rs->col_width = "100";
		$rs->SetRecordCol("Invoice NO.", "vid");
