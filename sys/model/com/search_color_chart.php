...
// print_r_pre($GLOBALS);
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        $rs->addnew_link = "?act=com-search_color_chart";
...
//        }
        ...
        $temp_table = ' color_chart';
        $list_field = ' SQL_CALC_FOUND_ROWS *, photo as color_chart_photo ';
        ...
        $rs->SetRecordCol("Color Chart Photo", "color_chart_photo");
        $rs->SetRecordCol("Color Chart Date", "color_chart_date");
        ...
        $sort = GENERAL_NO;
        $edit = GENERAL_YES;
        $rs->SetRecordCol("MODIFY", "id", $sort, $edit,"?act=com-modify_color_chart","modid");
        $rs->SetRecordCol("DEL", "id", $sort, $edit,"?act=com-modify_color_chart","delid");
        $rs->SetRSSorting('?act=com-search_color_chart');
