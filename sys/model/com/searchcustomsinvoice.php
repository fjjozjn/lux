...
// print_r_pre($GLOBALS);
?>
<h1 class="green">CUSTOMS INVOICE<em>* indicates required fields</em></h1>
...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<legend class='legend'>Search</legend>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td align="right">Customs Invoice NO. : </td>
...
<?
	...
	if ($getAnyPost || isset($_GET['page'])){
		...
		$rs->addnew_link = "?act=com-searchcustomsinvoice";
		...
		$temp_table = ' customs_invoice';
		$list_field = ' SQL_CALC_FOUND_ROWS vid, send_to, mark_date, printed_by, remark, istatus, total ';
		...
		//$rs->col_width = "100";
		$rs->SetRecordCol("Customs Invoice NO.", "vid");
		...
		$sort = GENERAL_NO;
		$edit = GENERAL_YES;
		$rs->SetRecordCol("PDF", "vid", $sort, $edit,"model/com/customs_invoice_pdf2.php?pdf=1","vid");
		$rs->SetRecordCol("MODIFY", "vid", $sort, $edit,"?act=com-modifycustomsinvoice","modid");
		$rs->SetRecordCol("DEL", "vid", $sort, $edit,"?act=com-modifycustomsinvoice","delid");
		$rs->SetRSSorting('?act=com-searchcustomsinvoice');
