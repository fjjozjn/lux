...
<table width="75%" id="table" class="formtitle" align="center">
	...
	<? }?>
        ...
        <table class="formtitle">
            ...
            <!-- <tr>
                <td><input type='file' name='sample_order_file' id='sample_order_file' /><input id="fileupload" type="file" name="files[]" data-url="index.php?ajax=1&act=ajax-sample_order_upload_file" multiple><a target="_blank" href="/sys/<?=""/*$sample_order_file_path_com.$mod_result['sample_order_file']*/?>"><?=""/*$mod_result['sample_order_file']*/?></a></td>
            </tr> -->
        </table>
...
<script src="/ui/jquery_file_upload/jquery.ui.widget.js"></script>
...
<script src="/ui/jquery_file_upload/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="/ui/jquery_file_upload/jquery.fileupload.js"></script>
<!-- The File Upload processing plugin -->
<script src="/ui/jquery_file_upload/jquery.fileupload-process.js"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="/ui/jquery_file_upload/jquery.fileupload-image.js"></script>
<!-- The File Upload audio preview plugin -->
<script src="/ui/jquery_file_upload/jquery.fileupload-audio.js"></script>
<!-- The File Upload video preview plugin -->
<script src="/ui/jquery_file_upload/jquery.fileupload-video.js"></script>
<!-- The File Upload validation plugin -->
<script src="/ui/jquery_file_upload/jquery.fileupload-validate.js"></script>
<script>
