...
$formItems = array(
		...
		'q_to' => array('title' => 'To', 'type' => 'select', 'options' => array('康而能图')),
		'q_reference' => array('title' => 'Reference', 'type' => 'text', 'minlen' => 1, 'maxlen' => 20),	
		'q_currency' => array('title' => 'Currency', 'type' => 'text', 'minlen' => 1, 'maxlen' => 20),
		'q_unit' => array('title' => 'Unit', 'type' => 'text', 'minlen' => 1, 'maxlen' => 20),
		'q_discount' => array('title' => 'Discount', 'type' => 'text', 'minlen' => 1, 'maxlen' => 20),
		
		'q_remark' => array('title' => 'Remark', 'type' => 'textarea', 'minlen' => 1, 'maxlen' => 200, 'rows' => 5),
		'q_remarks' => array('title' => 'Remarks', 'type' => 'textarea', 'minlen' => 1, 'maxlen' => 200, 'rows' => 5),
...
这里显示，quotation中的products，可任意增删
</fieldset>
...
$goodsForm->show('q_to');
$goodsForm->show('q_reference');
$goodsForm->show('q_currency');
$goodsForm->show('q_unit');
$goodsForm->show('q_discount');
?>
<br />
<?
$goodsForm->show('q_remark');
$goodsForm->show('q_remarks', '<div class="line"></div>');
...
?>
<fieldset class="center2col"> 
<legend class='legend'>Search quotation</legend>
这里搜索quotation，并可转为proforma
</fieldset>
<?
}
?>