...
// print_r_pre($GLOBALS);
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        $rs->addnew_link = "?act=com-search_qc_report";
...
/*        if (!isSysAdmin()){
        ...
        $rs->SetRecordCol("MODIFY", "qc_id", $sort, $edit,"?act=com-modify_qc_report","modid");
        $rs->SetRecordCol("DEL", "qc_id", $sort, $edit,"?act=com-modify_qc_report","delid");

        $rs->SetRSSorting('?act=com-search_qc_report');
