...
// print_r_pre($GLOBALS);
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        fb($_SESSION['search_criteria']['is_approve']);
        ...
        $rs->SetRecordCol("Creation Date", "created_date");
        ...
        if ($_SESSION['logininfo']['aName'] == 'ZJN' || $_SESSION['logininfo']['aName'] == 'KEVIN'){
            $rs->SetRecordCol("P_R_APPROVE", "id", $sort, $edit, "?act=com-modify_payment_request", "approveid");
        }
