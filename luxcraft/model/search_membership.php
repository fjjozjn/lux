...
// print_r_pre($temp_grp);
    ...
    $formItems = array(
        'phone' => array(
            'type' => 'text',
            'value' => @$_SESSION['search_criteria']['phone'],
        ),
        'start_date' => array(
            'type' => 'text',
            'restrict' => 'date',
...
// print_r_pre($GLOBALS);
    ?>
    <h1 class="green">MEMBERSHIP<em>* indicates required fields</em></h1>
                ...
                <fieldset>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td align="left"><? $form->show('phone'); ?></td>
                            <td align="right"></td>
                            <td align="left"></td>
                        </tr>
                        <tr>
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        $rs->addnew_link = "?act=search_membership";
        ...
        if (strlen(@$_SESSION['search_criteria']['phone'])){
            $where_sql.= " AND phone Like '%".$_SESSION['search_criteria']['phone'].'%\'';
        }
        ...
        $temp_table = ' luxcraft_membership';
        ...
        //$rs->col_width = "100";
        $rs->SetRecordCol("Phone", "phone");
        $rs->SetRecordCol("Name", "membership_name");
        ...
        $sort = GENERAL_NO;
        $edit = GENERAL_YES;
        $rs->SetRecordCol("MODIFY", "id", $sort, $edit,"?act=modify_membership","modid");
        $rs->SetRecordCol("DEL", "id", $sort, $edit,"?act=modify_membership","delid");
        $rs->SetRSSorting('?act=search_membership');
