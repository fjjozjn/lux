...
// print_r_pre($GLOBALS);
    ?>
    <h1 class="green">物料供应商联系人<em>* indicates required fields</em></h1>
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        $rs->addnew_link = "?act=search_wlgy_contact";
        ...
        $temp_table = ' fty_wlgy_contact c1, fty_wlgy_customer c2';
        ...
        $sort = GENERAL_NO;
        $edit = GENERAL_YES;
        $rs->SetRecordCol("修改", "id", $sort, $edit,"?act=modify_wlgy_contact","modid");
        $rs->SetRecordCol("删除", "id", $sort, $edit,"?act=com-modify_wlgy_contact","delid");
        $rs->SetRSSorting('?act=com-search_wlgy_contact');
