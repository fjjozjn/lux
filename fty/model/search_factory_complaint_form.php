...
// print_r_pre($GLOBALS);
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        $rs->addnew_link = "?act=search_factory_complaint_form";
        ...
        $rs->SetRecordCol("备注", "reply_remark");

        $sort = GENERAL_NO;
        $edit = GENERAL_YES;
        $rs->SetRecordCol("修改", "fc_id", $sort, $edit,"?act=modify_factory_complaint_form", "modid");
        //$rs->SetRecordCol("DEL", "fc_id", $sort, $edit,"?act=modify_factory_complaint_form", "delid");
        $rs->SetRSSorting('?act=search_factory_complaint_form');
