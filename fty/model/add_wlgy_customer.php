...
$formItems = array(
    ...
    'cid' => array('title' => '物料供应商编号', 'type' => 'text', 'minlen' => 1, 'maxlen' => 5, 'required' => 1),
    'name' => array('title' => '物料供应商名字', 'type' => 'textarea', 'minlen' => 1, 'maxlen' => 80, 'required' => 1),
...
if(!$myerror->getAny() && $goodsForm->check()){
    ...
    if(!$judge){
        ...
        if($result){
            ...
            $myerror->error('新增 物料供应商 失败', 'add_wlgy_customer');
        }
    }else{
        $myerror->error('物料供应商编号重复，新增失败', 'add_wlgy_customer');
    }
}
...
if($myerror->getError()){
    ...
    <fieldset class="center2col" style="width:60%">
        <legend class='legend'>新增物料供应商</legend>
