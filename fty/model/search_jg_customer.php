...
// print_r_pre($GLOBALS);
    ?>
    <h1 class="green">加工商<em>* indicates required fields</em></h1>
    ...
    if ($getAnyPost || isset($_GET['page'])){
        ...
        $rs->addnew_link = "?act=search_jg_customer";
        ...
        $sort = GENERAL_NO;
        $edit = GENERAL_YES;
        $rs->SetRecordCol("修改", "cid", $sort, $edit,"?act=modify_jg_customer","modid");
        //$rs->SetRecordCol("ADD", "cid", $sort, $edit,"?act=com-c_addcontact","cid");
        //20150622
        $rs->SetRecordCol("查看联系人", "cid", $sort, $edit,"?act=all_jg_contact","cid");
        $rs->SetRecordCol("删除", "cid", $sort, $edit,"?act=modify_jg_customer","delid");
        $rs->SetRSSorting('?act=search_jg_customer');
