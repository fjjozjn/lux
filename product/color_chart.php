...
//    die('@');
    ...
    $rs = $mysql->q('select id, color_chart_date, photo from color_chart order by id desc');
    $rtn = '';
    if($rs){
        $rtn = $mysql->fetch();
    }
...
//    die('#');
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/galleriffic2.css" type="text/css" />
        ...
        <script type="text/javascript" src="js/jquery.galleriffic2.js"></script>
            ...
            if($rs){
                ...
                <div id="thumbs" class="navigation">
                    <ul class="thumbs noscript">
                        ...
                        $first = true;
                        foreach($rtn as $v){
                            $date_month = substr($v['color_chart_date'], 0, 7);
                            if($first){
